...
class CollectionSeeder extends BaseSeeder
{
    ...
    public function run(): void
    {
        ...
        $subjects = [
            [
                'name' => 'Computing Power Reaches Milestone',
            ...
            [
                'name' => '5G: Next-Gen Connectivity Transforms Communication',
            ...
            [
                'name' => 'Tech Giants Collaborate on Open AI Framework',
            ...
            [
                'name' => 'Space Launches Mission to Establish First Human Colony on Mars',
            ...
            [
                'name' => 'Cybersecurity: New Protocols Bolster Digital Defense',
            ...
            [
                'name' => 'AI in Healthcare: Transformative Solutions for Patient Care',
            ...
            [
                'name' => 'Autonomous Systems Reshape Industries',
            ...
            [
                'name' => 'VR: Immersive Experiences Redefine Entertainment',
            ...
            [
                'name' => 'Innovative Wearables Track Health Metrics',
            ...
            [
                'name' => 'Startups Develop Solutions for Social and Environmental Issues',
            ...
            [
                'name' => 'Decentralized Finance (DeFi) Reshapes Finance Industry',
            ...
            [
                'name' => 'Secure Communication Enters a New Era',
            ...
            [
                'name' => 'Applications Expand Across Industries',
            ...
            [
                'name' => 'CRISPR-Cas9 Enables Precision Gene Editing',
            ...
            [
                'name' => 'Interactive Learning Experiences for Students',
            ...
            [
                'name' => 'Advancements in Self-Driving Car Technology',
            ...
            [
                'name' => 'Sustainable Solutions for a Greener Future',
            ...
            [
                'name' => 'Commercial Companies Make Strides in Space Travel',
            ...
            [
                'name' => 'AI Companions and Assistants',
        ...
        $this->createCollectionSubjects($subjects);
    }
}
