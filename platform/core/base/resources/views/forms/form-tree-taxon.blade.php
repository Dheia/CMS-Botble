...
@section('content')
    @php
        $taxons = $form->getFormOption('taxons', collect());
    ...
    <div class="row row-cards">
        ...
        <div class="col-md-4">
            <x-core::alert type="info">
                {{ trans('core/base::tree-taxon.drag_drop_info') }}
            </x-core::alert>

            <x-core::card class="tree-taxons-container">
                <x-core::card.header>
                    <x-core::card.actions>
                        @if ($createRoute)
                            <x-core::button
                ...
                <x-core::card.body class="tree-taxons-body">
                    <div
                        ...
                        @endif
                    >
                        @include('core/base::forms.partials.tree-taxons', compact('taxons'))
                    </div>
                </x-core::card.body>
            </x-core::card>
        </div>
...
@push('footer')
    <x-core::modal.action
        ...
        :title="trans('core/base::tree-taxon.delete_modal.title')"
        :description="trans('core/base::tree-taxon.delete_modal.message')"
        :submit-button-label="trans('core/base::tree-taxon.delete_button')"
