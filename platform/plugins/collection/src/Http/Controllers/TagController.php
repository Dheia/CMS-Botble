...
use Botble\Collection\Http\Requests\TagRequest;
use Botble\Collection\Models\Tag;
use Botble\Collection\Tables\TagTable;
...
class TagController extends BaseController
{
    protected function breadcrumb(): Breadcrumb
    {
        return parent::breadcrumb()
            ...
            ->add(trans('plugins/collection::tags.menu'), route('tags.index'));
    }

    public function index(TagTable $dataTable)
    {
        $this->pageTitle(trans('plugins/collection::tags.menu'));
    ...
    {
        $this->pageTitle(trans('plugins/collection::tags.create'));
